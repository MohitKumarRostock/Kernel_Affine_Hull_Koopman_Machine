...
import sys
PROJECT_ROOT_FOR_PATCHED_RUN = '/Users/mohit/Pythonprojects/Kernel_affine_hull_Koopman_machine'
...
SYSTEM_CONFIGS: dict[SystemName, SystemConfig] = {
    ...
    "vanderpol": SystemConfig(name="vanderpol", dt=0.02, n_clusters=10, omega=0.25, tau=1e-6),
}
