#!/usr/bin/env python3
"""Generate manuscript Figure 1 from Duffing abstraction-ablation outputs.
...
Place this script in the same directory as the experiment scripts and run:
    ...
    python step_15_generate_figure1_duffing_ablation.py
...
Outputs:
    figures/fig_duffing_ablation.pdf
    kahkm_figure1_duffing_ablation/fig_duffing_ablation.png
...
def parse_args() -> CliArgs:
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("kahkm_figure1_duffing_ablation"),
...
def make_figure(rows: Sequence[PlotRow], args: CliArgs) -> tuple[Path, Path]:
    ...
    png_path = args.output_dir / "fig_duffing_ablation.png"
